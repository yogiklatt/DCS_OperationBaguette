...
function SpawnSAMs()
	...
	if samThreat > 0 then
		trigger.action.outText("Setting up SAMs ... ", 10)
	
		ZoneBandarLengeh = ZONE:New( "ZoneSamBandarLengeh" )
		SAM1 = SPAWN:New( "IRQ EWR SA-2" ):SpawnInZone(ZoneBandarLengeh, true)
		
		-- Fixed SA-15
		PhalanxSpawnZoneFixed1 = ZONE:New( "PhalanxSpawnFixed1" )
		SAM2 = SPAWN:New( "IRQ EWR SA-15" ):SpawnInZone(PhalanxSpawnZoneFixed1, true)
		
		PhalanxSpawnZoneFixed2 = ZONE:New( "PhalanxSpawnFixed2" )
		SAM3 = SPAWN:New( "IRQ EWR SA-15" ):SpawnInZone(PhalanxSpawnZoneFixed2, true)
		
		ZoneEntry = ZONE:New( "ZoneSA2Entry" )
		SAM4 = SPAWN:New( "IRQ EWR SA-2" ):SpawnInZone(ZoneEntry, true)
		...
		elseif samThreat > 1 then
			...
			-- spawn an additional SA-2
			SAM5 = SPAWN:New( "IRQ EWR SA-2" ):SpawnInZone(ZoneSA2Island, true)
			...
			AAA1 = SPAWN:New('IRQ EWR ZU23'):SpawnInZone(ZoneAAA_01, true)
			AAA2 = SPAWN:New('IRQ EWR ZU23'):SpawnInZone(ZoneAAA_02, true)
			AAA3 = SPAWN:New('IRQ EWR ZU23'):SpawnInZone(ZoneAAA_03, true)
			AAA4 = SPAWN:New('IRQ EWR ZU23'):SpawnInZone(ZoneAAA_04, true)
...
function HandleGameMasterPlaneSpawn(airbaseOrZone)
	trigger.action.outText("Trying to spawn " .. table_gameMasterSpawns[int_selectedPlaneToSpawn].mySpawnName, 3000)
	...
	if airDensity > 0 or samThreat > 0 then
		...
		if airDensity > 0 and airDensity < 4 then
			...
			if airDensity == 4 then
				...
				-- airplanes
				table_gameMasterSpawns[11] = { myCategory = 1,mySpawnType = SPAWN:New( "IRQ SQ Easy L39" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ Easy L39"}
				table_gameMasterSpawns[12] = { myCategory = 1,mySpawnType = SPAWN:New( "IRQ SQ Easy MIG15" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ Easy MIG15"}
				table_gameMasterSpawns[21] = { myCategory = 2,mySpawnType = SPAWN:New( "IRQ SQ Fair F5" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ Fair F5"}
				table_gameMasterSpawns[22] = { myCategory = 2,mySpawnType = SPAWN:New( "IRQ SQ Fair F4" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ Fair F4"}
				table_gameMasterSpawns[23] = { myCategory = 2,mySpawnType = SPAWN:New( "IRQ SQ Fair MIG23" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ Fair MIG23"}
				table_gameMasterSpawns[31] = { myCategory = 3,mySpawnType = SPAWN:New( "IRQ SQ Hard F14" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ Hard F14"}
				table_gameMasterSpawns[32] = { myCategory = 3,mySpawnType = SPAWN:New( "IRQ SQ Hard MIG29" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ Hard MIG29"}
				table_gameMasterSpawns[33] = { myCategory = 3,mySpawnType = SPAWN:New( "IRQ SQ Hard Mirage" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ Hard Mirage"}
				table_gameMasterSpawns[34] = { myCategory = 3,mySpawnType = SPAWN:New( "IRQ SQ Hard F4" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ Hard F4"}
				table_gameMasterSpawns[35] = { myCategory = 3,mySpawnType = SPAWN:New( "IRQ SQ Hard MIG31" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ Hard MIG31"}
				table_gameMasterSpawns[36] = { myCategory = 3,mySpawnType = SPAWN:New( "IRQ SQ HARD MIG23" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ HARD MIG23"}
				table_gameMasterSpawns[41] = { myCategory = 4,mySpawnType = SPAWN:New( "IRQ SQ A2G SU25T" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ A2G SU25T"}
				table_gameMasterSpawns[42] = { myCategory = 4,mySpawnType = SPAWN:New( "IRQ SQ A2G SU34 SEAD" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ A2G SU34 SEAD"}
				table_gameMasterSpawns[43] = { myCategory = 4,mySpawnType = SPAWN:New( "IRQ SQ A2G SU34" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ A2G SU34"}
				table_gameMasterSpawns[44] = { myCategory = 4,mySpawnType = SPAWN:New( "IRQ SQ A2G TU22" ):InitGrouping(2):InitLimit(4,2), mySpawnName = "IRQ SQ A2G TU22"}
				...
				-- loop through all air bases and create the commands
